...
import TableNetProfit from './values/tableNetProfit';
    ...
    return (
        <>
            <tr key={index} className="p-3 ">
                ...
                <TableNetProfit deals={deals} userId={userId} currentValuation={currentValuation} sector={company?.dealSummary?.sector} />
                <td className='pe-4' >
