                    ...
                    {step === comps.length ? (
                        ...
                        <>
                            {/* <div className="row">
                                <div className="col-12 col-md-10 ps-0 ms-auto d-flex justify-content-between align-items-center">
                                    <div className="row">
                                        ...
                                        <div className="d-flex flex-column col-6 col-md-6 col-sm-12">
                                            <div className="logo">
                            ...
                            <div className="col-md-10 mx-auto pb-3 mt-auto">
                                <div className="col-md-10 mx-auto pe-0">
                                    ...
                                    <button
                                        ...
                                        onClick={handleStep}
                                        className={`${step >= 2 ? "btn-red" : `btn-${!personal && "dark"}-gray `
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 col-md-10 mx-auto pb-3 mt-auto">
                                    <div className="col-md-10 mx-auto pe-0">
                                        {step === comps.length - 1 && (
                                            <div className="mb-2 gap-2 cursor-pointer px-4 d-flex align-items-center">
                                                <input
                                                    onChange={(e) => {
                                                        setAccount((prev) => ({ ...prev, agreement: e.target.checked }));
                                                    }}
                                                    type="checkbox"
                                                    name="agree"
                                                    style={{
